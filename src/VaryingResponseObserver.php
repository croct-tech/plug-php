 ...
 *
 * It runs a callback whenever request-specific data is read or changed, that is, every operation
 * except reading the application ID. It is useful for integrations that need to keep the response
